...
americas=read_excel("C:/Users/Acer/Downloads/HR Dashboard_v1 - Americas.xlsx",sheet = "data")

apac=read_excel("C:/Users/Acer/Downloads/HR Dashboard_v1 - APAC.xlsx",sheet = "data")

europe=read_excel("C:/Users/Acer/Downloads/HR Dashboard_v1 - Europe.xlsx",sheet = "data")
...
country_coor=read_excel("C:/Users/Acer/Downloads/country coord.xlsx")
...
### Total new hires
```{r}
newhir0es=global %>% filter(`Type of movement`=="Entry") %>% nrow()
